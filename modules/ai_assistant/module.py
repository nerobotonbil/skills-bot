...
{"action": "save_idea", "idea": "краткое и понятное описание идеи"}

Правила обработки идей:
1. Если текст длинный и сумбурный - сократи до сути, сохрани главную мысль
2. Если текст уже краткий - немного отредактируй для ясности
3. Идея должна быть понятной при прочтении позже
4. Убери слова-паразиты и повторы
5. Сохрани ключевые детали

Пример:
Пользователь: "запиши идею, я тут подумал что было бы круто сделать приложение которое помогает людям находить интересные места в городе типа как гугл карты но только для локальных секретных мест"
Ответ: {"action": "save_idea", "idea": "Приложение для поиска локальных секретных мест в городе - альтернатива Google Maps для скрытых интересных локаций"}
