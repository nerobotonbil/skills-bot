...
MAX_VALUES = {
    ...
    "Video's": 5,          # Видео-истории (FBI, доктора и т.д.)
...
CONTENT_DESCRIPTIONS = {
    ...
    "Video's": "🎬 Видео — истории от профессионалов (FBI, доктора и др.)",
...
# Время напоминаний (часовой пояс пользователя)
TIMEZONE = os.getenv("TIMEZONE", "Asia/Dubai")  # GMT+4
